...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default-->
	...
	<div class="main-content">
        ...
        ?>
                    ...
                    <a href="photos.php?id=<?php echo $album['album_data']['id']; ?>"><img src="<?php echo $album['image_src']; ?>" alt="Album Cover" class="w-full cursor-pointer rounded-lg hover:scale-110 transition duration-300 ease-in-out"></a>
